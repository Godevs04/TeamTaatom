    ...
    >
      <div className="flex items-start">
        ...
        <div className="flex-1 py-3 pr-3 min-w-0">
          ...
          {block.type === 'heading' && (
            <input
              ...
              className="w-full text-lg font-semibold border-0 border-b border-transparent focus:border-gray-300 focus:outline-none bg-transparent px-0 py-1"
            />
          )}
          ...
          {block.type === 'text' && (
            <textarea
              ...
              rows={3}
              className="w-full text-sm border-0 border-b border-transparent focus:border-gray-300 focus:outline-none bg-transparent px-0 py-1 resize-none"
            />
          )}
        ...
        <button
          ...
          className="flex-shrink-0 p-3 text-gray-300 hover:text-red-500 transition-colors self-start"
          title="Remove block"
        >
