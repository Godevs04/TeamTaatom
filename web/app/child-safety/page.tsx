...
export default function ChildSafetyPage() {
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6 px-3 py-6 sm:px-4 sm:py-10 md:px-6">
      ...
      <section className="overflow-hidden rounded-3xl border border-emerald-200/90 bg-emerald-50/90 p-5 shadow-soft sm:p-6 md:p-7">
      ...
      <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
        <h2 className="text-lg font-semibold text-slate-900 md:text-xl">Executive Summary</h2>
      ...
      <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
        ...
        <div className="mt-4 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4">
          <h3 className="text-sm font-semibold text-slate-900">Age Requirement</h3>
          <p className="mt-2 text-sm text-slate-700">
        ...
        <div className="mt-4 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4">
          <h3 className="text-sm font-semibold text-slate-900">Account Creation</h3>
      ...
      <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
        <h2 className="text-lg font-semibold text-slate-900 md:text-xl">Child Safety Features</h2>

        <h3 className="mt-3 text-sm font-semibold text-slate-900">Content Guidelines</h3>
        <p className="mt-1 text-sm text-slate-700">
        ...
        <h3 className="mt-4 text-sm font-semibold text-slate-900">Reporting &amp; Moderation</h3>
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
          <li>
        ...
        <h3 className="mt-4 text-sm font-semibold text-slate-900">Blocking &amp; Restrictions</h3>
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
          <li>
      ...
      {/* Location & Privacy */}
      <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
        <h2 className="text-lg font-semibold text-slate-900 md:text-xl">Location &amp; Privacy</h2>
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
      ...
      <section className="rounded-3xl border border-emerald-200/80 bg-emerald-50/90 p-6 shadow-soft md:p-8">
        <h2 className="text-lg font-semibold text-emerald-900 md:text-xl">
