    ...
    <div className="mx-auto w-full max-w-5xl space-y-6 px-3 py-6 sm:px-4 sm:py-10 md:px-6">
      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
          <h2 className="text-lg font-semibold text-slate-900 md:text-xl">Agreement to Terms</h2>
          <p className="mt-2 text-sm text-slate-700">
            By using Taatom, you agree to these Terms of Service (&quot;Terms&quot;). You should
            read them carefully before using the App.
          </p>

          <h3 className="mt-5 text-sm font-semibold text-slate-900">Description of Service</h3>
        ...
        {/* User Accounts */}
        <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
          <h2 className="text-lg font-semibold text-slate-900 md:text-xl">User Accounts</h2>
          <h3 className="mt-3 text-sm font-semibold text-slate-900">Account Creation</h3>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
          ...
          <h3 className="mt-4 text-sm font-semibold text-slate-900">Account Responsibilities</h3>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
        ...
        {/* User Content */}
        <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
          <h2 className="text-lg font-semibold text-slate-900 md:text-xl">User Content</h2>
          <h3 className="mt-3 text-sm font-semibold text-slate-900">Content Ownership</h3>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
          ...
          <h3 className="mt-4 text-sm font-semibold text-slate-900">Content Guidelines</h3>
          <p className="mt-1 text-sm text-slate-700">
          ...
          <h3 className="mt-4 text-sm font-semibold text-slate-900">Content Moderation</h3>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
        ...
        <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
          ...
          <h3 className="mt-3 text-sm font-semibold text-slate-900">Your Responsibility</h3>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
            <li>
          ...
          <h3 className="mt-5 text-sm font-semibold text-slate-900">Prohibited Activities</h3>
          <p className="mt-1 text-sm text-slate-700">You agree not to:</p>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-700">
        ...
        <section className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-soft md:p-8">
          <h2 className="text-lg font-semibold text-slate-900 md:text-xl">Termination</h2>
          <p className="mt-2 text-sm text-slate-700">
          ...
          <h3 className="mt-5 text-sm font-semibold text-slate-900">Disclaimers</h3>
          <p className="mt-1 text-sm text-slate-700">
        ...
        {/* Contact */}
        <section className="rounded-3xl border border-indigo-200/80 bg-indigo-50/90 p-6 shadow-soft md:p-8">
          <h2 className="text-lg font-semibold text-indigo-900 md:text-xl">Contact</h2>
