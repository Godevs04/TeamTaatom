  ...
  if (!user) {
    return (
      <div className="rounded-2xl border border-slate-200/80 bg-white p-12 text-center shadow-premium">
        <p className="text-slate-600">Sign in to view activity.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <header className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-premium md:p-8">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 md:text-3xl">Activity Feed</h1>
        <p className="mt-1 text-sm text-slate-500">See what your friends are up to.</p>
      </header>
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-12 text-center shadow-premium">
          <p className="text-slate-600">Failed to load activity.</p>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-16 text-center shadow-premium">
          ...
          <h3 className="mt-6 text-lg font-semibold text-slate-900">No activity yet</h3>
          <p className="mt-2 text-[15px] text-slate-500">When people you follow post or like, it will show here.</p>
          <Link href="/search">
        ...
        <div className="space-y-2">
          {activities.map((a) => {
            ...
            return (
              <div
                key={a._id}
                className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-white p-4 shadow-premium"
              >
