  ...
  return (
    <div className="relative space-y-5 sm:space-y-6 lg:space-y-8">
      ...
      <div className="relative z-10 space-y-5 sm:space-y-6 lg:space-y-8">
        <div className="rounded-[1.75rem] border border-slate-200/80 bg-white/90 p-5 ui-panel shadow-premium dark:border-zinc-800/80 sm:p-6 md:p-8">
        ...
        <div className="rounded-[1.75rem] border border-slate-200/80 bg-white/90 p-4 ui-panel shadow-premium dark:border-zinc-800/80 sm:p-6">
