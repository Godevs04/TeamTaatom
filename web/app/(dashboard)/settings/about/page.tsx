  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white/95 p-5 shadow-soft backdrop-blur-sm dark:border-zinc-800/80 dark:bg-zinc-900/95 md:p-6">
        <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white md:text-2xl">About</h2>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Version 1.0.0</p>
        <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
          Share trips and experiences with your friends. For support and legal information, see Contact Support and Terms.
        </p>
      </div>
    </div>
  );
