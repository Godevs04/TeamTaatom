    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-slate-100 p-4">
          <h3 className="text-lg font-semibold text-slate-900">Add to Collection</h3>
        ...
        <div className="max-h-[60vh] overflow-y-auto p-2">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-sm font-medium text-slate-700">No collections</p>
              <p className="mt-1 text-xs text-slate-500">Create a collection first in Settings</p>
            </div>
          ) : (
              ...
              {collections.map((col) => (
                <li key={col._id}>
                  <button
                    ...
                    className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-left transition-colors hover:bg-slate-50 disabled:opacity-60"
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate text-sm font-medium text-slate-900">{col.name}</p>
