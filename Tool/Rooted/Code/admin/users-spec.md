...
End-user mobile/web APIs (e.g. `/api/v1/users`, `/api/v1/profile`) are separate from SuperAdmin user-management routes; see `README.md` for the high-level `/api/v1` mount list.
