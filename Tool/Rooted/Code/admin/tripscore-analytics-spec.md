...
- **Profile**: See `../profile/profile-spec.md` for user TripScore display
...
TripScore analytics is one menu in a larger shell. System health, support inbox, and permissions are centralized in `README.md` § *SuperAdmin routes & permissions*.
