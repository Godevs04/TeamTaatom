...
- **Route index**: See `README.md` § *SuperAdmin routes & permissions* for other SuperAdmin pages

---

## 15. Global SuperAdmin context (April 2026)

Support Inbox and System pages share the same authentication model as this analytics area but are specified at the repository level in `README.md` § *SuperAdmin routes & permissions*.
