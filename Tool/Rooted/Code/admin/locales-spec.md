...
- **Locale Discovery**: See `../locale/locale-spec.md` for frontend locale discovery
...
Public locale reads use `/api/v1/locales` for the mobile/web apps; SuperAdmin CRUD uses the authenticated admin routes documented in this spec—see `README.md` for how `/api/v1` categories align.
