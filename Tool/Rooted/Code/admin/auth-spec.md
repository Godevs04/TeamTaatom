...
- **Route index**: See `README.md` § *SuperAdmin routes & permissions* for `/system`, `/support-inbox`, `/profile`, and `/test` (dev)

---

## 15. Global SuperAdmin context (April 2026)

After login, operators may navigate to routes beyond this auth flow (e.g. `/system`, `/support-inbox`). See `README.md` § *SuperAdmin routes & permissions* and `dashboard-spec.md` §15 for cross-links.
