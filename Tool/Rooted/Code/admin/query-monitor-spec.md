...
- **Route index**: See `README.md` § *SuperAdmin routes & permissions* (includes `/system` health)

---

## 15. Global SuperAdmin context (April 2026)

For database/server health cards outside the query monitor page, operators may also use **`/system`** (`System.jsx`); see `settings-spec.md` §15 for Settings vs System.
