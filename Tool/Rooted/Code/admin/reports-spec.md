...
User-facing report submission uses mobile/web `/api/v1/reports` flows; this spec focuses on SuperAdmin triage. See `README.md` for the full SuperAdmin route index.
