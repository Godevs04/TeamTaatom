...
Song library management shares the same authenticated SuperAdmin shell as other `/superadmin` APIs; refer to `README.md` for mount paths and sidebar permissions.
