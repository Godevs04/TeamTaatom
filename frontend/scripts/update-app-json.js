...
appJson.expo.extra = {
  ...
  EXPO_PUBLIC_ADMOB_IOS_REWARDED_INTERSTITIAL_UNIT_ID:
    process.env.EXPO_PUBLIC_ADMOB_IOS_REWARDED_INTERSTITIAL_UNIT_ID ||
    existingExtra.EXPO_PUBLIC_ADMOB_IOS_REWARDED_INTERSTITIAL_UNIT_ID ||
    'ca-app-pub-6362359854606661/4698300005',
  EXPO_PUBLIC_ADMOB_ANDROID_REWARDED_INTERSTITIAL_UNIT_ID:
    process.env.EXPO_PUBLIC_ADMOB_ANDROID_REWARDED_INTERSTITIAL_UNIT_ID ||
    existingExtra.EXPO_PUBLIC_ADMOB_ANDROID_REWARDED_INTERSTITIAL_UNIT_ID ||
